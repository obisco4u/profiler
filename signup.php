...
if(isset($_POST["u"])){
	...
	// END FORM DATA ERROR HANDLING
		...
		$p_hash = md5($p);
		// randStrGen(20)."$cryptpass".randStrGen(20);
		// Add user info into the database table for the main site table
		$sql = "INSERT INTO users (username, email, phone, password, gender, country, ip, signup, lastlogin, notescheck)       
		        VALUES('$u','$e', '$ph', '$p_hash','$g','$c','$ip',now(),now(),now())";
		$query = mysqli_query($db_conx, $sql); 
