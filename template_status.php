...
$status_ui .=		'<div class="col-sm-12">';
$status_ui .=			'<div class="widget-area no-padding blank">';
$status_ui .=				'<div class="status-upload">';
$status_ui .=					'<form onsubmit="return false;">';
$status_ui .= 						'<textarea  id="statustext" onkeyup="statusMax(this,250)" placeholder="What&#39;s new with you '.$u.'?"></textarea>';
$status_ui .= 						'<button class="btn btn-success green" id="statusBtn" onclick="postToStatus(\'status_post\',\'a\',\''.$u.'\',\'statustext\')">Post</button>';
$status_ui .= 					'</form>';
$status_ui .= 				'</div>';
$status_ui .= 			'</div>';
$status_ui .= 		'</div>';
...
$status_ui .= 						'<button class="btn btn-success green" id="statusBtn" onclick="postToStatus(\'status_post\',\'c\',\''.$u.'\',\'statustext\')">Post</button>';
$status_ui .= 					'</form>';
$status_ui .= 				'</div>';
$status_ui .= 			'</div>';
$status_ui .= 		'</div>';
	...
	ajax.onreadystatechange = function() {
		if(ajaxReturn(ajax) == true) {
			...
			if(datArray[0] == "reply_ok"){
				...
				alert(ajax.responseText, "fucked up");
			}
		}
	}
